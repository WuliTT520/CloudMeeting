package com.zhihui.imeeting.cloudmeeting.widget;
...
//import com.zhihui.imeeting.cloudmeeting.widget.ItemTitle;
...
public class DragGridView<T extends ItemTitle> extends GridLayout implements View.OnLongClickListener, View.OnClickListener {
    ...
    private static final int DEFAULT_TEXT_NORMAL_BACKGROUND = R.drawable.black_background;
    private static final int DEFAULT_TEXT_SELECTED_BACKGROUND = R.drawable.black_background;
    ...
    private com.zhihui.imeeting.cloudmeeting.widget.DragGridView.OnItemClickListener mListener;
     ...
     * @param listener
     */
    public void setOnItemClickListener(com.zhihui.imeeting.cloudmeeting.widget.DragGridView.OnItemClickListener listener) {
        mListener = listener;
    }
}
