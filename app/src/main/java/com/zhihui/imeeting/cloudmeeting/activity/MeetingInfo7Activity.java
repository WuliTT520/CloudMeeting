...
public class MeetingInfo7Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meeting_info7);
        init();
        getInfo();
        setListener();
    }
    public void init(){
        ...
        handler=new Handler(){
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    case 404:
                        Toast.makeText(MeetingInfo7Activity.this,"网络错误",Toast.LENGTH_LONG).show();
                        break;
                    case 500:
                        Toast.makeText(MeetingInfo7Activity.this,"数据错误",Toast.LENGTH_LONG).show();
                        break;
                    case 200:
...
//                setResult(500);
        ...
        join_people.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(MeetingInfo7Activity.this,JoinMemberListActivity.class);
        ...
        diao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(MeetingInfo7Activity.this,DiaoActivity.class);
