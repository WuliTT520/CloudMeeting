...
public class QiangActivity extends Activity {
...
//        getInfo();
    ...
    public void init(){
        ...
        handler=new Handler(){
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    case 404:
                        Toast.makeText(QiangActivity.this,"网络错误",Toast.LENGTH_LONG).show();
                        break;
                    case 500:
                        Toast.makeText(QiangActivity.this,message,Toast.LENGTH_LONG).show();
                        break;
                    case 200:
                        Toast.makeText(QiangActivity.this,"操作成功",Toast.LENGTH_LONG).show();
                        finish();
                        break;
                }
            }
    ...
    public void setListener(){
        ...
        member.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(QiangActivity.this,AttendeeActivity.class);
        ...
        prepare.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                OptionsPickerView pvOptions = new OptionsPickerBuilder(QiangActivity.this, new OnOptionsSelectListener() {
                    @Override
        ...
        qiang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (topic.getText()==null||content.getText()==null||member_id.length==0||boardroomId==0){
                    Toast.makeText(QiangActivity.this,"请完成填写信息",Toast.LENGTH_LONG).show();
                }else {
                    try {
