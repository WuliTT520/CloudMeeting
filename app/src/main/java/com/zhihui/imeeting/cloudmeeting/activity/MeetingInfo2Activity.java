...
public class MeetingInfo2Activity extends Activity {
    private static final String TAG="MeetingInfo2Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meeting_info2);
        init();
        getInfo();
        setListener();
    }
    public void init(){
        ...
        handler=new Handler(){
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    case 404:
                        Toast.makeText(MeetingInfo2Activity.this,"网络错误",Toast.LENGTH_LONG).show();
                        break;
                    case 500:
                        Toast.makeText(MeetingInfo2Activity.this,"数据错误",Toast.LENGTH_LONG).show();
                        break;
                    case 200:
...
//                Intent intent=getIntent();
        ...
        join_people.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(MeetingInfo2Activity.this,JoinMemberListActivity.class);
